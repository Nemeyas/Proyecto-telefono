...
public class Guardar extends javax.swing.JFrame {
     ...
     */
    public Guardar(Empresa emp) {
        initComponents();
        this.emp = emp;
        jLabel1.setText("Ingrese el nombre del nuevo archivo(termine con csv)");
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Archivo.csv...");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        CSV nuevo = new CSV();
        try{
            nuevo.Exportar(nombre, emp);
            Ventana wind = new Ventana(emp);
            wind.setVisible(true);
            this.dispose();
        } catch(Exception e){
            jTextField1.setText("Ingrese un nombre valido");
        }
