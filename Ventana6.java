...
public class Ventana6 extends javax.swing.JFrame {
    ...
    public Ventana6(Empresa emp) {
        ...
        jLabel1.setText("Ingrese el cliente que busca");
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try{
            aux = emp.existeCliente(nombreCliente);
            if(aux == false){
            jTextArea1.setText("El plan ingresado no existe");
            }
        }
        catch(ClienteRepetidoException e){
            jTextArea1.append("Nombre"+nombreCliente+"\n");
            int pos = emp.posicionClienteLista(nombreCliente);
            jTextArea1.append(String.valueOf("Deuda: "+emp.getClienteDeuda(pos)+"\n"));
            jTextArea1.append(String.valueOf("Rut: "+emp.getClienteRut(pos)+"\n"));
            jTextArea1.append("Planes:"+"\n");
            jTextArea1.append(String.valueOf(emp.getClientePlanes(pos).size()));
            for(int i = 0; i < emp.getClientePlanes(pos).size(); i++){
                jTextArea1.append(String.valueOf(emp.getClientePlanes(pos).get(i)+"\n"));
